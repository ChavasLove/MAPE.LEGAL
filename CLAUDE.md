...
- **Persona**: María, asistente de MAPE LEGAL — español sencillo, respuestas cortas (≤5 líneas), sin emojis, sin jerga. **Audiencia (2026-07-29, alineada con Fase 2C)**: mineros artesanales, **operadores de pequeña minería** (tromel/zaranda/bomba — medios mecánicos) y propietarios de tierra; al presentarse menciona ambos regímenes (instrucción en el header de `lib/maria/systemPrompt.ts`)
