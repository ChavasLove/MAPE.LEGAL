...
- **Primer producto real (2026-07-27)**: `planta-lavado-oro-aluvial-100tph` — Planta de Lavado de Oro Aluvial 100 TPH, **USD 118,000 CIF Honduras** (precio fijo, sin rango), `destacado: true, orden: 0` (encabeza el catálogo — el RPC ordena `destacado DESC, orden ASC`). 8 imágenes de specs en `public/images/equipos/planta-lavado-oro-aluvial-100tph/01..08.jpeg` (01 = portada, 02–08 = galería). Circuito: tolva grizzly 25 m³ → alimentador vibratorio ~70 mm → trommel 1500 (70–100 TPH) → centrífugo STLB80 → 2× mesas 6S-4500 + 2× esclusas en colas → horno de fundición. Se ingresa re-corriendo `node scripts/seed-equipos.mjs` (idempotente — los 12 productos demo existentes se skipean por slug).
