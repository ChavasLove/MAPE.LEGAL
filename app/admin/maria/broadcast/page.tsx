    ...
    <div>
      ...
      {loading ? (
        ...
        <>
          ...
          <Card
            title="Horario"
            subtitle="El boletín se envía una vez al día a las 08:00 (hora Honduras), según el cron diario de Vercel. En el plan actual la hora es fija; para programarla a otra hora se requiere el plan Pro (cron sub-diario)."
          >
            <div className="flex items-center gap-3">
